...
blind500_train_path=$HOME/data/blind500+800_bird/test_mcq.parquet
blind500_test_path=$HOME/data/blind500+800_bird/test_mcq.parquet
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2.5_0.5B_conv' \
