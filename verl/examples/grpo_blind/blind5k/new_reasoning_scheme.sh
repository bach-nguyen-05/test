...
blind500_train_path=$HOME/data/blind5k_new_reasoning_scheme/train_mcq.parquet
blind500_test_path=$HOME/data/blind5k_new_reasoning_scheme/test_mcq.parquet
...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.rollout.cot=false \
    actor_rollout_ref.ref.log_prob_micro_batch_size_per_gpu=16 \
    actor_rollout_ref.ref.fsdp_config.param_offload=True \
    algorithm.kl_ctrl.kl_coef=0.001 \
    trainer.critic_warmup=0 \
    trainer.logger=['console','wandb'] \
    trainer.project_name='blind5k_debug_v9' \
    trainer.experiment_name='qwen2.5_7b_new_scheme' \
