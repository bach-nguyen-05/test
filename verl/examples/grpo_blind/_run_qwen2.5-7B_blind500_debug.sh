...
blind500_train_path=$HOME/data/blind500/train_mcq.parquet
blind500_test_path=$HOME/data/blind500/test_mcq.parquet
...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.rollout.overwrite_system_prompt=/home/asurite.ad.asu.edu/zhaonan2/Blind_VQA/verl/examples/grpo_blind/new_system_prompt.txt \
    ...
    trainer.project_name='blind500_grpo_dev7' \
    trainer.experiment_name='qwen2.5_7B_conv' \
