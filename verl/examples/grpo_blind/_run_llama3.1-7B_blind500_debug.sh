...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.rollout.start_marker="'<|start_header_id|>'" \
    +actor_rollout_ref.rollout.gen_start_marker="'<|start_header_id|>assistant<|end_header_id|>'" \
    +actor_rollout_ref.rollout.end_marker="'<|eot_id|>'" \
    +actor_rollout_ref.rollout.end_role_marker="'<|end_header_id|>'" \
    ...
    trainer.project_name='blind500_grpo_dev5' \
    trainer.experiment_name='llama3.1_7B_conv' \
